...
<body>
    ...
    <?php
        require_once "configs/editarPacienteBD.php";
    ?>
    <div class="container">
        <form method="POST" action="editarPaciente.php">
            <div class="mb-3">
                <label for="inputNome" class="form-label">Nome</label>
                <input name="nome" type="text" class="form-control" id="inputNome" value="<?= $paciente["nome"]?>">
            </div>
            <div class="mb-3">
                <label for="inputData" class="form-label">Data de Nascimento</label>
                <input name="data" type="date" class="form-control" id="inputData" value="<?= $paciente["dataNascimento"]?>">
            </div>
