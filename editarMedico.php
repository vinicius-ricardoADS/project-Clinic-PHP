    ...
    <div class="container">
        <form method="POST" action="editarMedico.php">
            ...
            <div class="mb-3">
                ...
                <input name="data" type="date" class="form-control" id="inputData" value="<?= $medico["dataCadastro"]?>">
            </div>
            <div class="mb-3">
                <label for="inputSelect" class="form-label">Especialidades</label>
                <select class="form-select" aria-label="Default select example" name="idEspecialidade" id="inputSelect">
                    <?php
                        $especialidades = Especialidade::getId($medico["idEspecialidade"]);
                    ?>
                    <option selected disabled><?= $especialidades["nome"]?></option>
